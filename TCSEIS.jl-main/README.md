...
a. Make sure that in Atom you are have selected the TCSEIS1D folder. If you are new to julia know that:
...
d. Run the command Run_All(). This command runs the full sequence of TCSEIS1D.
...
- How do I install GMT to be able to used TCSEIS1D?
